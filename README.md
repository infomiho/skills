...
```bash
npx skills add infomiho/skills
```

Install a specific skill:

```bash
npx skills add infomiho/skills --skill scratch
```

## Skills

- `browser-bridge` - Control an existing Firefox or Chrome tab through a local Bun bridge and DevTools injection.
- `source-to-article` - Turn supplied source material into a grounded, readable, self-contained HTML article.
